        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/jurusan/update/<?php echo e($in->id); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nis') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nama_jurusan" type="text" class="form-control" name="nama_jurusan" value="<?php echo e($in->nama_jurusan); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('type_jurusan') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="type_jurusan" value="<?php echo e($in->type_jurusan); ?>" class="form-control" id="type_jurusan">
