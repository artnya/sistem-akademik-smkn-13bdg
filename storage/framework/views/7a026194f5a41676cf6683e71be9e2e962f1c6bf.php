        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('verify', Auth()->user()->id)); ?>">
                      ...
                      <div class="alert alert-info alert-dismissible">
                        ...
                        <div class="form-group<?php echo e($errors->has('id_jurusan') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <select id="id_jurusan" class="form-control select2" name="id_jurusan" value="<?php echo e(old('id_jurusan')); ?>" required>
                                    ...
                                    <option value="<?php echo e($on->id); ?>"><?php echo e($on->nama_jurusan); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
