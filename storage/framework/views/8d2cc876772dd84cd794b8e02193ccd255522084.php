        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="panel-body">
                	...
                	<?php else: ?>
                	<form action="/guru/resetpic/<?php echo e($in->id); ?>" method="post">
                    ...
                    <?php endif; ?>
                    <form class="form-horizontal" method="POST" action="/guru/uploadpic/<?php echo e($in->id); ?>" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
