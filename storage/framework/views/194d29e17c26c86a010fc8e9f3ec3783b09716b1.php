...
<div class="wrapper">
	...
	<?php echo $__env->make('layouts.header-siswa', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

	<?php echo $__env->yieldContent('content-siswa'); ?>

	<?php echo $__env->make('layouts.footer-siswa', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
