            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li><a style="background-color: #d2d6de;" href="/home/timeline"><i class="fa fa-comments text-aqua"></i> (<?php echo e($no); ?>) <?php echo e($notification->data['id']); ?> <?php echo e($notification->data['data']); ?></a></li>
                  <?php elseif($notification->type == 'App\Notifications\ReportNotification'): ?>
                  <li><a style="background-color: #d2d6de;" href="/home/timeline"><i class="fa fa-warning text-yellow"></i> (<?php echo e($no); ?>) <?php echo e($notification->data['id']); ?> <?php echo e($notification->data['data']); ?></a></li>
                  <?php endif; ?>
                  <?php $no++; ?>
                  ...
                  <?php if($notification->type == 'App\Notifications\CommentNotification'): ?>
                  <li><a href="#"><i class="fa fa-comments text-aqua"></i> <?php echo e($notification->data['id']); ?> <?php echo e($notification->data['data']); ?></a></li>
                  <?php elseif($notification->type == 'App\Notifications\ReportNotification'): ?>
                  <li><a href="#"><i class="fa fa-warning text-yellow"></i> <?php echo e($notification->data['id']); ?> <?php echo e($notification->data['data']); ?></a></li>
                  <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php else: ?>
