                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-toggle="modal" data-target="#delete{{$x->id}}" class="btn btn-default text-red"><i class="fa fa-trash"></i></a>
                        </div>
                      </td>
                      @endif
                    </tr>
...
@include('mapel.produktif.edit')
@include('mapel.produktif.create')
@include('mapel.produktif.delete')
