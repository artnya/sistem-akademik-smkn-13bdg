      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline timeline-aqua">
            ...
            <li class="time-label">
                  <span class="bg-red">
                    {{ $today->format('l jS \\of F Y h:i:s A') }}
                  </span>
            </li>
            <!-- /.timeline-label -->
            <!-- timeline item -->
            ...
            <li id="retrieve">
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-body">
                  {!! str_limit($notification->data['comment'], '45') !!}
                </div>
                <div class="timeline-footer">
                  <a href="/home/discuss-group/comment/post/{{ $notification->data['postmu'] }}#{{ $notification->data['last_row'] }}" class="btn btn-warning btn-flat btn-xs">View comment</a>
                </div>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-footer">
                  <a href="{{route('notify-read-one', $notification->id)}}" class="btn btn-warning btn-flat btn-xs">View report</a>
                </div>
              </div>
            </li>
            @endif
